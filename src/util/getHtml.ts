export default function getButton(cond: number, id: string){
    if (cond === 0) {
        const emailHtml =
            `<table style="width: 100%; height: 100%; min-width: 348px; border: 0; background-color: #212121dc;">
            <tbody>
              <tr align="center">
                <td>
                        ...
                        <td>
                          <div
                            ...
                            <div style="display: inline-flex;"> <img
                                src="https://cdn.discordapp.com/attachments/300483456440336385/790994294517137418/nintube_banner_icon_light.png" width="74"
                            ...
                            <div
                              ...
                              Por Favor verifique seu email clicando no botão abaixo.<div
                                ...
                                text-align: center;
                              ">
                                  <img src="https://cdn.discordapp.com/attachments/300483456440336385/790994294517137418/nintube_banner_icon_light.png" width="27"
                  ...
                  <tr>
                    ...
                    <td>
                      <div
                        ...
                        align="center" class="m_4541679764111361952mdv2rw">
                        <div style="display: inline-flex;"> <img
                            src="https://youtube-videos-furg.s3.sa-east-1.amazonaws.com/nintube_icon1.png" width="74"
                            height="74" aria-hidden="true" style="margin-bottom:16px" class="CToWUd">
                          <h1 style="margin-left: 5%;">NinTube</h1>
                        </div>
                        ...
                        <div
                          ...
                          Se sim clicar no link abaixo para altera-la.<div
                            ...
                            text-align: center;
                          ">
                              <img src="https://youtube-videos-furg.s3.sa-east-1.amazonaws.com/nintube_icon1.png" width="27"
                                height="25" class="CToWUd">
                              Alterar senha</a></div>
                        </div>
                      </div>
